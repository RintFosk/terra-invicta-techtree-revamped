...
UI.MissionPhase.ConfirmPrompt=你有尚未分配任务的理事。<br/>确定要结束任务阶段吗？
UI.MissionPhase.ConfirmYes=确认
UI.MissionPhase.ConfirmNo=哦，不！
...
UI.MissionPhase.NoTargets=当前没有有效目标，该理事无法执行此项任务。
UI.MissionPhase.NoTargetLocation=有些任务目标会显示为无效，这是由于理事受特质影响，无法移动到任务地点：
